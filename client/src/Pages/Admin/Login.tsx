...
import { adminLogin } from "../../api/req.js";
...
const Login = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-300 to-green-300  dark:bg-gray-900 min-h-screen flex items-center justify-center">
